...
export const userService = {
  ...
  async updateProfile(payload: UpdateUserProfilePayload) {
    const res = await api.patch<UpdateUserProfileResponse>("/users/me", payload);
    return res.data;
  },
  ...
  async getNotificationSettings() {
    const res = await api.get<UserNotificationSettingsResponse>("/users/notification-settings");
    return res.data;
  },

  async updateNotificationSettings(payload: UpdateUserNotificationSettingsPayload) {
  ...
  async submitBankAccountVerificationRequest(payload: BankAccountVerificationPayload) {
  ...
  async getDepositReceivingAccount() {
    const res = await api.get<DepositReceivingAccountResponse>("/users/deposit-account");
    return res.data;
  },
  ...
  async getFinancialOverview() {
    const res = await api.get<UserFinancialOverviewResponse>("/users/financial-overview");
    return res.data;
  },

  async getHomeOverview() {
    const res = await api.get<UserHomeOverviewResponse>("/users/home-overview", {
      params: { at: Date.now() },
    });
    return res.data;
  },
  ...
  async getBroadcastNotifications() {
    const res = await api.get<UserBroadcastNotificationsResponse>("/users/broadcast-notifications");
    return res.data;
  },

  async getFinanceSettings() {
    const res = await api.get<FinanceSettingsResponse>("/users/finance-settings");
    return res.data;
  },
  ...
  async getTaskHistory() {
    const res = await api.get<UserTaskHistoryResponse>("/users/task-submissions");
    return res.data;
  },
  ...
  async getDepositRequest(requestId: string) {
    const res = await api.get<{ request: DepositRequest }>(`/users/deposit-requests/${requestId}`);
    return res.data;
  },
